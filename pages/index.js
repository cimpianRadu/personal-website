...
import { Text, Heading, VStack, Flex, Divider } from "@chakra-ui/react";
        ...
        <VStack spacing="12">
          <Flex justifyContent="center">
            <article style={{ textAlign: "center" }}>
              ...
              <Text fontSize="2xl">Since you are here, please let me introduce myself. 💁🏻‍♂️</Text>
            </article>
          </Flex>
          <Heading textAlign="center">
            I'm Radu Gheorghe Cîmpian, 27 years old and I live in{" "}
            <a className={styles.underlinedLink} target="_blank" href={CLUJ_GOOGLE_MAPS}>
              {" "}
            ...
            <br />
            <article>
              I'm an experinced software engineer specialized on building beautiful applications using Javascript ecosystem. I contribuited on building digital
              products in various domains from
              <i> education </i> 📚 <i>, agriculture </i>🚜 to <i>betting & gambling </i>🎰
